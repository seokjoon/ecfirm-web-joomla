...
class EcprodTableProdorderObserver extends JTableObserver {
	...
	public function onAfterDelete($pk) { 
		EcDml::updateColumnCount('ecprod', 'prod', $this->table->prod, 'prodorder', -1);
	}
	...
	public function onAfterStore(&$result) { 
		if($this->valueCol != $this->table->prod) 
			EcDml::updateColumnCount('ecprod', 'prod', $this->table->prod, 'prodorder', 1);
	}
}