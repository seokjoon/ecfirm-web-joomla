...
class EcpageTablePagelikeObserver extends JTableObserver {
	...
	public function onAfterDelete($pk) { 
		EcDml::updateColumnCount('ecpage', 'page', $this->table->page, 'pagelike', -1);
	}
	...
	public function onAfterStore(&$result) { 
		if($this->valueCol != $this->table->page) 
			EcDml::updateColumnCount('ecpage', 'page', $this->table->page, 'pagelike', 1);
	}
}