...
class EccontTableContlikeObserver extends JTableObserver {
	...
	public function onAfterDelete($pk) { 
		EcDml::updateColumnCount('eccont', 'cont', $this->table->cont, 'contlike', -1);
	}
	...
	public function onAfterStore(&$result) { 
		if($this->valueCol != $this->table->cont) 
			EcDml::updateColumnCount('eccont', 'cont', $this->table->cont, 'contlike', 1);
	}
}